...
function ShowOverlay(charname) {
	...
	var TonyPageDesc = "The Tony mask is a striking and iconic animal mask featured in Hotline Miami. Shaped like a fierce tiger, it offers players a visually distinctive and empowering choice for their character's appearance in the game. Equipping the Tony mask not only alters the player's appearance but also provides a range of gameplay benefits and opportunities.";
	var TonyPageEvents = "<h3>Hotline Miami</h3> In Hotline Miami, wearing the Tony mask grants players a set of gameplay bonuses that can greatly enhance their abilities and strategies. The specific effects and advantages bestowed by the mask can vary based on the game's mechanics and the player's progress.";
	TonyPageEvents += "<br><br>The Tony mask empowers players with heightened agility, speed, and ferocity, mirroring the attributes commonly associated with tigers. This translates into faster movement, improved melee combat prowess, and increased resistance to certain types of damage.";
	TonyPageEvents += "<br><br>Furthermore, the mask's unique abilities can enhance the player's stealth capabilities and effectiveness in close-quarter combat. Its distinct visual appearance also serves as an intimidation factor, striking fear into the hearts of enemies and potentially altering their behavior and reactions.";
	TonyPageEvents += "<br><br>By donning the Tony mask, players can adopt a more aggressive and daring playstyle, pouncing on enemies with deadly force and swiftly maneuvering through levels with unmatched grace. The mask's gameplay benefits encourage experimentation and creative approaches, allowing players to unleash their inner tiger and dominate the challenging scenarios presented throughout the game.";
	TonyPageEvents += "<br><br>Hotline Miami's mask system, including the Tony mask, contributes to the game's overall depth and replayability. With a wide selection of masks to choose from, each with its own unique attributes, players can tailor their gameplay experience to suit their preferred style and strategic preferences.";
	TonyPageEvents += "<br><br>As players progress through the game and unlock additional masks, including Tony, they gain access to new gameplay options and strategic possibilities. The Tony mask, in particular, stands out as an embodiment of raw power and aggression, offering players an exhilarating and distinctive way to approach the fast-paced, violent world of Hotline Miami.";
	...
	switch(charname){
		...
		case "Corey":
			...
			document.getElementsByClassName("OverlayImage")[0].src = "./img/characters/CoreyMasked.webp";
		...
		case "Mark":
			...
			document.getElementsByClassName("OverlayImage")[0].src = "./img/characters/Jasked.webp";
			tableCells[0].innerHTML = "Position: US Special Forces Operative (1985)<br>Unspecified Job(1991)<br>Vigilante(1991)";
